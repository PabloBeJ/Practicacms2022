...
<head>
    ...
    <title>Tenistas de Wimbledon 2022</title>
...
<nav>
    <div class="nav-wrapper">
        ...
        <a href="<?php echo $_SESSION['home'] ?>" class="brand-logo" title="Inicio">
            <img src="<?php echo $_SESSION['public'] ?>img/logoWimbledon.png" alt="Wimbledon 2022">
        </a>
        <!--Botón menú móviles-->
        ...
        <ul id="nav-mobile" class="right hide-on-med-and-down">
            ...
            <li>
                <a href="<?php echo $_SESSION['home'] ?>tenistas" title="Tenistas">Tenistas</a>
            </li>
            <li>
...
<main>
    <header>
        <h1>Tenistas de Wimbledon 2022</h1>
    </header>
